                ...
                <div class="container-fluid">
                    <div class="row justify-between items-center q-col-gutter-md">
                        ...
                        <div  class="col-md-auto col-12 " >
                            <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   :to="`/tftitulares/add`" class="full-width" >
                ...
                <div class="row q-col-gutter-x-md">
                    <div  class="col comp-grid" >
                        ...
                        <div >
                            <template v-if="showBreadcrumbs && pageBreadCrumb.fieldName">
                                <q-card class="q-pa-md q-mb-sm text-bold nice-shadow-6">
                                    <q-breadcrumbs>
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="pageBreadCrumb.fieldName" to="/tftitulares"></q-breadcrumbs-el>
                        ...
                        <div >
                            ...
                            :bordered="false"
                            :columns="app.menus.tftitulareslistheader" 
                            :rows="records"
                            ...
                            <template v-slot:body="props">
                                <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                    ...
                                    <q-td  key="form_adquisicion" :props="props">
                                        {{ props.row.form_adquisicion }}
                                    </q-td>
                                    <q-td  key="fecha_adquisicion" :props="props">
                                        {{ props.row.fecha_adquisicion }}
                                    </q-td>
                                    <q-td  key="porc_cotitular" :props="props">
                                        {{ props.row.porc_cotitular }}
                                    </q-td>
                                    <q-td  key="esta_civil" :props="props">
                                        {{ props.row.esta_civil }}
                                    </q-td>
                                    <q-td  key="fax" :props="props">
                                        {{ props.row.fax }}
                                    </q-td>
                                    <q-td  key="telf" :props="props">
                                        {{ props.row.telf }}
                                    </q-td>
                                    <q-td  key="anexo" :props="props">
                                        {{ props.row.anexo }}
                                    </q-td>
                                    ...
                                    <q-td  key="nume_titular" :props="props">
                                        {{ props.row.nume_titular }}
                                    </q-td>
                                    <q-td  key="codi_contribuyente" :props="props">
                                        {{ props.row.codi_contribuyente }}
                                    </q-td>
                                    <q-td  key="cond_titular" :props="props">
                                        {{ props.row.cond_titular }}
                                    </q-td>
                                            ...
                                            <q-btn icon="menu" padding="xs" round flat color="grey">
                                                <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                    <q-list dense rounded nav>
                                                        <q-item link clickable v-ripple :to="`/tftitulares/view/${props.row.id_ficha}`">
                                                            <q-item-section>
                                                                <q-icon color="primary" size="sm" name="visibility"></q-icon>
                                                            </q-item-section>
                                                            <q-item-section>View</q-item-section>
                                                        </q-item>
                                                        <q-item link clickable v-ripple :to="`/tftitulares/edit/${props.row.id_ficha}`">
                                                            <q-item-section>
...
<script setup>
	...
	const props = defineProps({
		...
		routeName : {
			type : String,
			default : 'tftitulareslist',
		},
		apiPath : {
			type : String,
			default : 'tftitulares/index',
		},
		autoLoad: {
			type: Boolean,
			default: true,
