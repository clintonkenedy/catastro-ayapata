                ...
                <div class="container-fluid">
                    <div class="row justify-between items-center q-col-gutter-md">
                        ...
                        <div  class="col-md-auto col-12 " >
                            <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   :to="`/tflinderos/add`" class="full-width" >
                ...
                <div class="row q-col-gutter-x-md">
                    <div  class="col comp-grid" >
                        ...
                        <div >
                            <template v-if="showBreadcrumbs && pageBreadCrumb.fieldName">
                                <q-card class="q-pa-md q-mb-sm text-bold nice-shadow-6">
                                    <q-breadcrumbs>
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="pageBreadCrumb.fieldName" to="/tflinderos"></q-breadcrumbs-el>
                        ...
                        <div >
                            ...
                            :bordered="false"
                            :columns="app.menus.tflinderoslistheader" 
                            :rows="records"
                            ...
                            <template v-slot:body="props">
                                <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                    ...
                                    <q-td  key="fren_campo" :props="props">
                                        {{ props.row.fren_campo }}
                                    </q-td>
                                    <q-td  key="fren_titulo" :props="props">
                                        {{ props.row.fren_titulo }}
                                    </q-td>
                                    <q-td  key="fren_colinda_campo" :props="props">
                                        {{ props.row.fren_colinda_campo }}
                                    </q-td>
                                    <q-td  key="fren_colinda_titulo" :props="props">
                                        {{ props.row.fren_colinda_titulo }}
                                    </q-td>
                                    <q-td  key="dere_campo" :props="props">
                                        {{ props.row.dere_campo }}
                                    </q-td>
                                    <q-td  key="dere_titulo" :props="props">
                                        {{ props.row.dere_titulo }}
                                    </q-td>
                                    <q-td  key="dere_colinda_campo" :props="props">
                                        {{ props.row.dere_colinda_campo }}
                                    </q-td>
                                    <q-td  key="dere_colinda_titulo" :props="props">
                                        {{ props.row.dere_colinda_titulo }}
                                    </q-td>
                                    <q-td  key="izqu_campo" :props="props">
                                        {{ props.row.izqu_campo }}
                                    </q-td>
                                    <q-td  key="izqu_titulo" :props="props">
                                        {{ props.row.izqu_titulo }}
                                    </q-td>
                                    <q-td  key="izqu_colinda_campo" :props="props">
                                        {{ props.row.izqu_colinda_campo }}
                                    </q-td>
                                    <q-td  key="izqu_colinda_titulo" :props="props">
                                        {{ props.row.izqu_colinda_titulo }}
                                    </q-td>
                                    <q-td  key="fond_titulo" :props="props">
                                        {{ props.row.fond_titulo }}
                                    </q-td>
                                    <q-td  key="fond_campo" :props="props">
                                        {{ props.row.fond_campo }}
                                    </q-td>
                                    <q-td  key="fond_colinda_campo" :props="props">
                                        {{ props.row.fond_colinda_campo }}
                                    </q-td>
                                    <q-td  key="fond_colinda_titulo" :props="props">
                                        {{ props.row.fond_colinda_titulo }}
                                    </q-td>
                                            ...
                                            <q-btn icon="menu" padding="xs" round flat color="grey">
                                                <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                    <q-list dense rounded nav>
                                                        <q-item link clickable v-ripple :to="`/tflinderos/view/${props.row.id_ficha}`">
                                                            <q-item-section>
                                                                <q-icon color="primary" size="sm" name="visibility"></q-icon>
                                                            </q-item-section>
                                                            <q-item-section>View</q-item-section>
                                                        </q-item>
                                                        <q-item link clickable v-ripple :to="`/tflinderos/edit/${props.row.id_ficha}`">
                                                            <q-item-section>
...
<script setup>
	...
	const props = defineProps({
		...
		routeName : {
			type : String,
			default : 'tflinderoslist',
		},
		apiPath : {
			type : String,
			default : 'tflinderos/index',
		},
		autoLoad: {
			type: Boolean,
			default: true,
