                    ...
                    <div class="row justify-between items-center q-col-gutter-md">
                        <div  class="col " >
                            <div class=" text-h6 text-primary" >
                                Tf Servicios Basicos
                            </div>
                        </div>
                        <div  class="col-md-auto col-12 " >
                            <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   :to="`/tfserviciosbasicos/add`" class="full-width" >
                ...
                <div class="row q-col-gutter-x-md">
                    <div  class="col comp-grid" >
                        ...
                        <div >
                            <template v-if="showBreadcrumbs && pageBreadCrumb.fieldName">
                                <q-card class="q-pa-md q-mb-sm text-bold nice-shadow-6">
                                    <q-breadcrumbs>
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="pageBreadCrumb.fieldName" to="/tfserviciosbasicos"></q-breadcrumbs-el>
                        ...
                        <div >
                            ...
                            :bordered="false"
                            :columns="app.menus.tfserviciosbasicoslistheader" 
                            :rows="records"
                            ...
                            <template v-slot:body="props">
                                <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                    ...
                                    <q-td  key="desague" :props="props">
                                        {{ props.row.desague }}
                                    </q-td>
                                    <q-td  key="nume_sum_luz" :props="props">
                                        {{ props.row.nume_sum_luz }}
                                    </q-td>
                                    <q-td  key="nume_telefono" :props="props">
                                        {{ props.row.nume_telefono }}
                                    </q-td>
                                    <q-td  key="nume_contrato_agua" :props="props">
                                        {{ props.row.nume_contrato_agua }}
                                    </q-td>
                                            ...
                                            <q-btn icon="menu" padding="xs" round flat color="grey">
                                                <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                    <q-list dense rounded nav>
                                                        <q-item link clickable v-ripple :to="`/tfserviciosbasicos/view/${props.row.id_ficha}`">
                                                            <q-item-section>
                                                                <q-icon color="primary" size="sm" name="visibility"></q-icon>
                                                            </q-item-section>
                                                            <q-item-section>View</q-item-section>
                                                        </q-item>
                                                        <q-item link clickable v-ripple :to="`/tfserviciosbasicos/edit/${props.row.id_ficha}`">
                                                            <q-item-section>
...
<script setup>
	...
	const props = defineProps({
		...
		routeName : {
			type : String,
			default : 'tfserviciosbasicoslist',
		},
		apiPath : {
			type : String,
			default : 'tfserviciosbasicos/index',
		},
		autoLoad: {
			type: Boolean,
			default: true,
