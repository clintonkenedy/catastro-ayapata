                ...
                <div class="container-fluid">
                    <div class="row justify-between items-center q-col-gutter-md">
                        ...
                        <div  class="col-md-auto col-12 " >
                            <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   :to="`/tfsunarp/add`" class="full-width" >
                ...
                <div class="row q-col-gutter-x-md">
                    <div  class="col comp-grid" >
                        ...
                        <div >
                            <template v-if="showBreadcrumbs && pageBreadCrumb.fieldName">
                                <q-card class="q-pa-md q-mb-sm text-bold nice-shadow-6">
                                    <q-breadcrumbs>
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="pageBreadCrumb.fieldName" to="/tfsunarp"></q-breadcrumbs-el>
                        ...
                        <div >
                            ...
                            :bordered="false"
                            :columns="app.menus.tfsunarplistheader" 
                            :rows="records"
                            ...
                            <template v-slot:body="props">
                                <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                    ...
                                    <q-td  key="nume_partida" :props="props">
                                        {{ props.row.nume_partida }}
                                    </q-td>
                                    <q-td  key="fojas" :props="props">
                                        {{ props.row.fojas }}
                                    </q-td>
                                    <q-td  key="asiento" :props="props">
                                        {{ props.row.asiento }}
                                    </q-td>
                                    <q-td  key="fech_inscripcion" :props="props">
                                        {{ props.row.fech_inscripcion }}
                                    </q-td>
                                    <q-td  key="codi_decla_fabrica" :props="props">
                                        {{ props.row.codi_decla_fabrica }}
                                    </q-td>
                                    <q-td  key="asie_fabrica" :props="props">
                                        {{ props.row.asie_fabrica }}
                                    </q-td>
                                    <q-td  key="fecha_fabrica" :props="props">
                                        {{ props.row.fecha_fabrica }}
                                    </q-td>
                                            ...
                                            <q-btn icon="menu" padding="xs" round flat color="grey">
                                                <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                    <q-list dense rounded nav>
                                                        <q-item link clickable v-ripple :to="`/tfsunarp/view/${props.row.id_ficha}`">
                                                            <q-item-section>
                                                                <q-icon color="primary" size="sm" name="visibility"></q-icon>
                                                            </q-item-section>
                                                            <q-item-section>View</q-item-section>
                                                        </q-item>
                                                        <q-item link clickable v-ripple :to="`/tfsunarp/edit/${props.row.id_ficha}`">
                                                            <q-item-section>
...
<script setup>
	...
	const props = defineProps({
		...
		routeName : {
			type : String,
			default : 'tfsunarplist',
		},
		apiPath : {
			type : String,
			default : 'tfsunarp/index',
		},
		autoLoad: {
			type: Boolean,
			default: true,
