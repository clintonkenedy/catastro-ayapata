                ...
                <div class="container-fluid">
                    <div class="row justify-between items-center q-col-gutter-md">
                        ...
                        <div  class="col-md-auto col-12 " >
                            <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   :to="`/tfinstitucion/add`" class="full-width" >
                ...
                <div class="row q-col-gutter-x-md">
                    <div  class="col comp-grid" >
                        ...
                        <div >
                            <template v-if="showBreadcrumbs && pageBreadCrumb.fieldName">
                                <q-card class="q-pa-md q-mb-sm text-bold nice-shadow-6">
                                    <q-breadcrumbs>
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="pageBreadCrumb.fieldName" to="/tfinstitucion"></q-breadcrumbs-el>
                        ...
                        <div >
                            ...
                            :bordered="false"
                            :columns="app.menus.tfinstitucionlistheader" 
                            :rows="records"
                            ...
                            <template v-slot:body="props">
                                <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                    ...
                                    <q-td  key="id_institucion" :props="props">
                                        <q-btn padding="xs"   :rounded="false"  color="primary"  no-caps  unelevated   flat :to="`/tfinstitucion/view/${props.row.id_institucion}`">{{ props.row.id_institucion }}</q-btn>
                                    </q-td>
                                    <q-td  key="desc_institucion" :props="props">
                                        {{ props.row.desc_institucion }}
                                    </q-td>
                                    <q-td  key="dire_institucion" :props="props">
                                        {{ props.row.dire_institucion }}
                                    </q-td>
                                    ...
                                    <q-td  key="autoridad" :props="props">
                                        {{ props.row.autoridad }}
                                    </q-td>
                                    <q-td  key="cargo" :props="props">
                                        {{ props.row.cargo }}
                                    </q-td>
                                    <q-td  key="fecha_registro" :props="props">
                                        {{ props.row.fecha_registro }}
                                    </q-td>
                                    <q-td  key="nume_ip" :props="props">
                                        {{ props.row.nume_ip }}
                                    </q-td>
                                    <q-td  key="nomb_host" :props="props">
                                        {{ props.row.nomb_host }}
                                    </q-td>
                                            ...
                                            <q-btn icon="menu" padding="xs" round flat color="grey">
                                                <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                    <q-list dense rounded nav>
                                                        <q-item link clickable v-ripple :to="`/tfinstitucion/view/${props.row.id_institucion}`">
                                                            <q-item-section>
                                                                <q-icon color="primary" size="sm" name="visibility"></q-icon>
                                                            </q-item-section>
                                                            <q-item-section>View</q-item-section>
                                                        </q-item>
                                                        <q-item link clickable v-ripple :to="`/tfinstitucion/edit/${props.row.id_institucion}`">
                                                            <q-item-section>
                                                                <q-icon color="positive" size="sm" name="edit"></q-icon>
                                                            </q-item-section>
                                                            <q-item-section>Edit</q-item-section>
                                                        </q-item>
                                                        <q-item link clickable v-ripple @click="deleteItem(props.row.id_institucion)">
                                                            <q-item-section>
...
<script setup>
	...
	const props = defineProps({
		...
		routeName : {
			type : String,
			default : 'tfinstitucionlist',
		},
		apiPath : {
			type : String,
			default : 'tfinstitucion/index',
		},
		autoLoad: {
			type: Boolean,
			default: true,
