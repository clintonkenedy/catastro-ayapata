                ...
                <div class="container-fluid">
                    <div class="row justify-between items-center q-col-gutter-md">
                        ...
                        <div  class="col-md-auto col-12 " >
                            <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   :to="`/tfconstrucciones/add`" class="full-width" >
                ...
                <div class="row q-col-gutter-x-md">
                    <div  class="col comp-grid" >
                        ...
                        <div >
                            <template v-if="showBreadcrumbs && pageBreadCrumb.fieldName">
                                <q-card class="q-pa-md q-mb-sm text-bold nice-shadow-6">
                                    <q-breadcrumbs>
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="pageBreadCrumb.fieldName" to="/tfconstrucciones"></q-breadcrumbs-el>
                        ...
                        <div >
                            ...
                            :bordered="false"
                            :columns="app.menus.tfconstruccioneslistheader" 
                            :rows="records"
                            ...
                            <template v-slot:body="props">
                                <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                    ...
                                    <q-td  key="id_construccion" :props="props">
                                        <q-btn padding="xs"   :rounded="false"  color="primary"  no-caps  unelevated   flat :to="`/tfconstrucciones/view/${props.row.id_construccion}`">{{ props.row.id_construccion }}</q-btn>
                                    </q-td>
                                    ...
                                    <q-td  key="codi_construccion" :props="props">
                                        {{ props.row.codi_construccion }}
                                    </q-td>
                                    <q-td  key="nume_piso" :props="props">
                                        {{ props.row.nume_piso }}
                                    </q-td>
                                    <q-td  key="fecha" :props="props">
                                        {{ props.row.fecha }}
                                    </q-td>
                                    <q-td  key="mep" :props="props">
                                        {{ props.row.mep }}
                                    </q-td>
                                    <q-td  key="ecs" :props="props">
                                        {{ props.row.ecs }}
                                    </q-td>
                                    <q-td  key="ecc" :props="props">
                                        {{ props.row.ecc }}
                                    </q-td>
                                    <q-td  key="estr_muro_col" :props="props">
                                        {{ props.row.estr_muro_col }}
                                    </q-td>
                                    <q-td  key="estr_techo" :props="props">
                                        {{ props.row.estr_techo }}
                                    </q-td>
                                    <q-td  key="acab_piso" :props="props">
                                        {{ props.row.acab_piso }}
                                    </q-td>
                                    <q-td  key="acab_puerta_ven" :props="props">
                                        {{ props.row.acab_puerta_ven }}
                                    </q-td>
                                    <q-td  key="acab_revest" :props="props">
                                        {{ props.row.acab_revest }}
                                    </q-td>
                                    <q-td  key="acab_bano" :props="props">
                                        {{ props.row.acab_bano }}
                                    </q-td>
                                    <q-td  key="inst_elect_sanita" :props="props">
                                        {{ props.row.inst_elect_sanita }}
                                    </q-td>
                                            ...
                                            <q-btn icon="menu" padding="xs" round flat color="grey">
                                                <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                    <q-list dense rounded nav>
                                                        <q-item link clickable v-ripple :to="`/tfconstrucciones/view/${props.row.id_construccion}`">
                                                            <q-item-section>
                                                                <q-icon color="primary" size="sm" name="visibility"></q-icon>
                                                            </q-item-section>
                                                            <q-item-section>View</q-item-section>
                                                        </q-item>
                                                        <q-item link clickable v-ripple :to="`/tfconstrucciones/edit/${props.row.id_construccion}`">
                                                            <q-item-section>
                                                                <q-icon color="positive" size="sm" name="edit"></q-icon>
                                                            </q-item-section>
                                                            <q-item-section>Edit</q-item-section>
                                                        </q-item>
                                                        <q-item link clickable v-ripple @click="deleteItem(props.row.id_construccion)">
                                                            <q-item-section>
...
<script setup>
	...
	const props = defineProps({
		...
		routeName : {
			type : String,
			default : 'tfconstruccioneslist',
		},
		apiPath : {
			type : String,
			default : 'tfconstrucciones/index',
		},
		autoLoad: {
			type: Boolean,
			default: true,
