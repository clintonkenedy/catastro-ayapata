                ...
                <div class="container-fluid">
                    <div class="row justify-between items-center q-col-gutter-md">
                        ...
                        <div  class="col-md-auto col-12 " >
                            <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   :to="`/tfinstalaciones/add`" class="full-width" >
                ...
                <div class="row q-col-gutter-x-md">
                    <div  class="col comp-grid" >
                        ...
                        <div >
                            <template v-if="showBreadcrumbs && pageBreadCrumb.fieldName">
                                <q-card class="q-pa-md q-mb-sm text-bold nice-shadow-6">
                                    <q-breadcrumbs>
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="pageBreadCrumb.fieldName" to="/tfinstalaciones"></q-breadcrumbs-el>
                        ...
                        <div >
                            ...
                            :bordered="false"
                            :columns="app.menus.tfinstalacioneslistheader" 
                            :rows="records"
                            ...
                            <template v-slot:body="props">
                                <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                    ...
                                    <q-td  key="id_instalacion" :props="props">
                                        <q-btn padding="xs"   :rounded="false"  color="primary"  no-caps  unelevated   flat :to="`/tfinstalaciones/view/${props.row.id_instalacion}`">{{ props.row.id_instalacion }}</q-btn>
                                    </q-td>
                                    ...
                                    <q-td  key="codi_instalacion" :props="props">
                                        <q-btn v-if="props.row.codi_instalacion" @click="app.openPageDialog({ page: 'tfcodigosinstalaciones/view', url: `/tfcodigosinstalaciones/view/${props.row.codi_instalacion}` , closeBtn: true })" padding="xs" flat color="primary" no-caps >
                                            <q-icon name="visibility" size="xs"  class="q-mr-xs"></q-icon>  Tf Codigos Instalaciones
                                        </q-btn>
                                    </q-td>
                                    <q-td  key="codi_obra" :props="props">
                                        {{ props.row.codi_obra }}
                                    </q-td>
                                    ...
                                    <q-td  key="dime_largo" :props="props">
                                        {{ props.row.dime_largo }}
                                    </q-td>
                                    <q-td  key="dime_ancho" :props="props">
                                        {{ props.row.dime_ancho }}
                                    </q-td>
                                    <q-td  key="dime_alto" :props="props">
                                        {{ props.row.dime_alto }}
                                    </q-td>
                                    <q-td  key="prod_total" :props="props">
                                        {{ props.row.prod_total }}
                                    </q-td>
                                    <q-td  key="uni_med" :props="props">
                                        {{ props.row.uni_med }}
                                    </q-td>
                                            ...
                                            <q-btn icon="menu" padding="xs" round flat color="grey">
                                                <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                    <q-list dense rounded nav>
                                                        <q-item link clickable v-ripple :to="`/tfinstalaciones/view/${props.row.id_instalacion}`">
                                                            <q-item-section>
                                                                <q-icon color="primary" size="sm" name="visibility"></q-icon>
                                                            </q-item-section>
                                                            <q-item-section>View</q-item-section>
                                                        </q-item>
                                                        <q-item link clickable v-ripple :to="`/tfinstalaciones/edit/${props.row.id_instalacion}`">
                                                            <q-item-section>
                                                                <q-icon color="positive" size="sm" name="edit"></q-icon>
                                                            </q-item-section>
                                                            <q-item-section>Edit</q-item-section>
                                                        </q-item>
                                                        <q-item link clickable v-ripple @click="deleteItem(props.row.id_instalacion)">
                                                            <q-item-section>
...
<script setup>
	...
	const props = defineProps({
		...
		routeName : {
			type : String,
			default : 'tfinstalacioneslist',
		},
		apiPath : {
			type : String,
			default : 'tfinstalaciones/index',
		},
		autoLoad: {
			type: Boolean,
			default: true,
