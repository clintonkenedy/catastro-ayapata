                                        ...
                                        <div class="col-12">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9 col-12">
                                                    <api-data-source @loaded="response => mapOptionField(response, 'codi_actividad')"  api-path="components_data/codi_actividad_option_list"  v-slot="req">
                                                        <nice-select     :loading="req.loading"   ref="ctrlcodi_actividad" v-model="formData.codi_actividad" :options="req.response" label="Codi Actividad"  :error="isFieldValid('codi_actividad')" :error-message="getFieldError('codi_actividad')">
                                                        </nice-select>  
                                                    </api-data-source>
                                                </div>
                                            </div>
...
<script setup>
	...
	const props = defineProps({
		...
		routeName: {
			type: String,
			default: 'tfautorizacionesfuncionamientoedit',
		},
		pagePath: {
			type : String,
			default : 'tfautorizacionesfuncionamiento/edit',
		},
		apiPath: {
			type: String,
			default: 'tfautorizacionesfuncionamiento/edit',
	...
	function afterSubmit(response) {
		...
		if(app.isDialogOpen()){
			...
			app.navigateTo(`/tfautorizacionesfuncionamiento`);
		}
	}
