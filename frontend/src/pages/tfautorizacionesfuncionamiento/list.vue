                    ...
                    <div class="row justify-between items-center q-col-gutter-md">
                        <div  class="col " >
                            <div class=" text-h6 text-primary" >
                                Tf Autorizaciones Funcionamiento
                            </div>
                        </div>
                        <div  class="col-md-auto col-12 " >
                            <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   :to="`/tfautorizacionesfuncionamiento/add`" class="full-width" >
                ...
                <div class="row q-col-gutter-x-md">
                    <div  class="col comp-grid" >
                        ...
                        <div >
                            <template v-if="showBreadcrumbs && pageBreadCrumb.fieldName">
                                <q-card class="q-pa-md q-mb-sm text-bold nice-shadow-6">
                                    <q-breadcrumbs>
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="pageBreadCrumb.fieldName" to="/tfautorizacionesfuncionamiento"></q-breadcrumbs-el>
                        ...
                        <div >
                            ...
                            :bordered="false"
                            :columns="app.menus.tfautorizacionesfuncionamientolistheader" 
                            :rows="records"
                            ...
                            <template v-slot:body="props">
                                <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                    ...
                                    <q-td  key="codi_actividad" :props="props">
                                        <q-btn v-if="props.row.codi_actividad" @click="app.openPageDialog({ page: 'tfactividades/view', url: `/tfactividades/view/${props.row.codi_actividad}` , closeBtn: true })" padding="xs" flat color="primary" no-caps >
                                            <q-icon name="visibility" size="xs"  class="q-mr-xs"></q-icon>  Tf Actividades
                                        </q-btn>
                                    </q-td>
                                            ...
                                            <q-btn icon="menu" padding="xs" round flat color="grey">
                                                <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                    <q-list dense rounded nav>
                                                        <q-item link clickable v-ripple :to="`/tfautorizacionesfuncionamiento/view/${props.row.codi_actividad}`">
                                                            <q-item-section>
                                                                <q-icon color="primary" size="sm" name="visibility"></q-icon>
                                                            </q-item-section>
                                                            <q-item-section>View</q-item-section>
                                                        </q-item>
                                                        <q-item link clickable v-ripple :to="`/tfautorizacionesfuncionamiento/edit/${props.row.codi_actividad}`">
                                                            <q-item-section>
                                                                <q-icon color="positive" size="sm" name="edit"></q-icon>
                                                            </q-item-section>
                                                            <q-item-section>Edit</q-item-section>
                                                        </q-item>
                                                        <q-item link clickable v-ripple @click="deleteItem(props.row.codi_actividad)">
                                                            <q-item-section>
...
<script setup>
	...
	const props = defineProps({
		...
		routeName : {
			type : String,
			default : 'tfautorizacionesfuncionamientolist',
		},
		apiPath : {
			type : String,
			default : 'tfautorizacionesfuncionamiento/index',
		},
		autoLoad: {
			type: Boolean,
			default: true,
	...
	const pageTitle = computed({
		get: function () {
			return "Tf Autorizaciones Funcionamiento"
		}
	});
