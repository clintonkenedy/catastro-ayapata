                                    ...
                                    <div class="row q-col-gutter-x-md">
                                        ...
                                        <div class="col-12">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9 col-12">
                                                    <q-input   ref="ctrlporcentaje" v-model.trim="formData.porcentaje"  label="Porcentaje" type="number" placeholder="Escribir Porcentaje"   step="0.1"    
...
<script setup>
	...
	const props = defineProps({
		...
		routeName: {
			type: String,
			default: 'tfexoneracionespredioedit',
		},
		pagePath: {
			type : String,
			default : 'tfexoneracionespredio/edit',
		},
		apiPath: {
			type: String,
			default: 'tfexoneracionespredio/edit',
	...
	function afterSubmit(response) {
		...
		if(app.isDialogOpen()){
			...
			app.navigateTo(`/tfexoneracionespredio`);
		}
	}
