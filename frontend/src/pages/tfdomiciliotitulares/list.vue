                    ...
                    <div class="row justify-between items-center q-col-gutter-md">
                        <div  class="col " >
                            <div class=" text-h6 text-primary" >
                                Tf Domicilio Titulares
                            </div>
                        </div>
                        <div  class="col-md-auto col-12 " >
                            <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   :to="`/tfdomiciliotitulares/add`" class="full-width" >
                ...
                <div class="row q-col-gutter-x-md">
                    <div  class="col comp-grid" >
                        ...
                        <div >
                            <template v-if="showBreadcrumbs && pageBreadCrumb.fieldName">
                                <q-card class="q-pa-md q-mb-sm text-bold nice-shadow-6">
                                    <q-breadcrumbs>
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="pageBreadCrumb.fieldName" to="/tfdomiciliotitulares"></q-breadcrumbs-el>
                        ...
                        <div >
                            ...
                            :bordered="false"
                            :columns="app.menus.tfdomiciliotitulareslistheader" 
                            :rows="records"
                            ...
                            <template v-slot:body="props">
                                <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                    ...
                                    <q-td  key="id_ficha" :props="props">
                                        <q-btn padding="xs"   :rounded="false"  color="primary"  no-caps  unelevated   flat :to="`/tfdomiciliotitulares/view/${props.row.id_ficha}`">{{ props.row.id_ficha }}</q-btn>
                                    </q-td>
                                    <q-td  key="id_persona" :props="props">
                                        <q-btn v-if="props.row.id_persona" @click="app.openPageDialog({ page: 'tfpersonas/view', url: `/tfpersonas/view/${props.row.id_persona}` , closeBtn: true })" padding="xs" flat color="primary" no-caps >
                                            <q-icon name="visibility" size="xs"  class="q-mr-xs"></q-icon>  Tf Personas
                                        </q-btn>
                                    </q-td>
                                    <q-td  key="codi_via" :props="props">
                                        {{ props.row.codi_via }}
                                    </q-td>
                                    <q-td  key="tipo_via" :props="props">
                                        {{ props.row.tipo_via }}
                                    </q-td>
                                    <q-td  key="nomb_via" :props="props">
                                        {{ props.row.nomb_via }}
                                    </q-td>
                                    <q-td  key="nume_muni" :props="props">
                                        {{ props.row.nume_muni }}
                                    </q-td>
                                    <q-td  key="nomb_edificacion" :props="props">
                                        {{ props.row.nomb_edificacion }}
                                    </q-td>
                                    <q-td  key="nume_interior" :props="props">
                                        {{ props.row.nume_interior }}
                                    </q-td>
                                    <q-td  key="codi_hab_urba" :props="props">
                                        {{ props.row.codi_hab_urba }}
                                    </q-td>
                                    <q-td  key="nomb_hab_urba" :props="props">
                                        {{ props.row.nomb_hab_urba }}
                                    </q-td>
                                    <q-td  key="sector" :props="props">
                                        {{ props.row.sector }}
                                    </q-td>
                                    <q-td  key="mzna" :props="props">
                                        {{ props.row.mzna }}
                                    </q-td>
                                    <q-td  key="lote" :props="props">
                                        {{ props.row.lote }}
                                    </q-td>
                                    <q-td  key="sublote" :props="props">
                                        {{ props.row.sublote }}
                                    </q-td>
                                    <q-td  key="codi_dep" :props="props">
                                        {{ props.row.codi_dep }}
                                    </q-td>
                                    <q-td  key="codi_pro" :props="props">
                                        {{ props.row.codi_pro }}
                                    </q-td>
                                    <q-td  key="codi_dis" :props="props">
                                        {{ props.row.codi_dis }}
                                    </q-td>
                                            ...
                                            <q-btn icon="menu" padding="xs" round flat color="grey">
                                                <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                    <q-list dense rounded nav>
                                                        <q-item link clickable v-ripple :to="`/tfdomiciliotitulares/view/${props.row.id_ficha}`">
                                                            <q-item-section>
                                                                <q-icon color="primary" size="sm" name="visibility"></q-icon>
                                                            </q-item-section>
                                                            <q-item-section>View</q-item-section>
                                                        </q-item>
                                                        <q-item link clickable v-ripple :to="`/tfdomiciliotitulares/edit/${props.row.id_ficha}`">
                                                            <q-item-section>
...
<script setup>
	...
	const props = defineProps({
		...
		routeName : {
			type : String,
			default : 'tfdomiciliotitulareslist',
		},
		apiPath : {
			type : String,
			default : 'tfdomiciliotitulares/index',
		},
		autoLoad: {
			type: Boolean,
			default: true,
