                ...
                <div class="container-fluid">
                    <div class="row justify-between items-center q-col-gutter-md">
                        ...
                        <div  class="col-md-auto col-12 " >
                            <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   @click="app.openPageDialog({ page: 'tfactividades/add', url: `/tfactividades/add` , closeBtn: true  })"  class="full-width" >
                ...
                <div class="row q-col-gutter-x-md">
                    <div  class="col comp-grid" >
                        ...
                        <div >
                            <template v-if="showBreadcrumbs && pageBreadCrumb.fieldName">
                                <q-card class="q-pa-md q-mb-sm text-bold nice-shadow-6">
                                    <q-breadcrumbs>
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="pageBreadCrumb.fieldName" to="/tfactividades"></q-breadcrumbs-el>
                        ...
                        <div >
                            ...
                            :bordered="false"
                            :columns="app.menus.tfactividadeslistheader" 
                            :rows="records"
                            ...
                            <template v-slot:body="props">
                                <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                    ...
                                    <q-td  key="codi_actividad" :props="props">
                                        <q-btn padding="xs"   :rounded="false"  color="primary"  no-caps  unelevated   flat :to="`/tfactividades/view/${props.row.codi_actividad}`">{{ props.row.codi_actividad }}</q-btn>
                                    </q-td>
                                    <q-td  key="desc_actividad" :props="props">
                                        {{ props.row.desc_actividad }}
                                    </q-td>
                                    <q-td key="btnactions" :props="props" >
                                        <div class="row q-col-gutter-xs justify-end">
                                            <div><q-btn icon="edit"   outline  :rounded="false"  no-caps  unelevated   padding="xs" color="positive" title="Editar"  @click="app.openPageDialog({ page:'tfactividades/edit', url: `/tfactividades/edit/${props.row.codi_actividad}` , closeBtn: true })">
                                            </q-btn></div>
                                            <div><q-btn icon="delete_sweep"   outline  :rounded="false"  no-caps  unelevated   padding="xs" color="negative" title="Eliminar"  @click="deleteItem(props.row.codi_actividad)">
                                            </q-btn></div>
                                        </div>
                                    </q-td>
                                </q-tr>
...
<script setup>
	...
	const props = defineProps({
		...
		routeName : {
			type : String,
			default : 'tfactividadeslist',
		},
		apiPath : {
			type : String,
			default : 'tfactividades/index',
		},
		autoLoad: {
			type: Boolean,
			default: true,
