                                    ...
                                    <div class="row q-col-gutter-x-md">
                                        ...
                                        <div class="col-12">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9 col-12">
                                                    <q-input   ref="ctrlcodi_contribuye" v-model.trim="formData.codi_contribuye"  label="Codi Contribuye" type="text" placeholder="Escribir Codi Contribuye"      
                                                    class="" :error="isFieldValid('codi_contribuye')" :error-message="getFieldError('codi_contribuye')">
                                                    </q-input>
                                                </div>
                                            </div>
                                        </div>
...
<script setup>
	...
	const props = defineProps({
		...
		routeName: {
			type: String,
			default: 'tflitigantesedit',
		},
		pagePath: {
			type : String,
			default : 'tflitigantes/edit',
		},
		apiPath: {
			type: String,
			default: 'tflitigantes/edit',
