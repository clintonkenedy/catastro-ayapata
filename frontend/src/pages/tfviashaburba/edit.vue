                                        ...
                                        <div class="col-12">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9 col-12">
                                                    <api-data-source @loaded="response => mapOptionField(response, 'id_hab_urba')"  api-path="components_data/id_hab_urba_option_list"  v-slot="req">
                                                        <nice-select     :loading="req.loading"   ref="ctrlid_hab_urba" v-model="formData.id_hab_urba" :options="req.response" label="Id Hab Urba"  :error="isFieldValid('id_hab_urba')" :error-message="getFieldError('id_hab_urba')">
                                                        </nice-select>  
                                                    </api-data-source>
                                                </div>
                                            </div>
...
<script setup>
	...
	const props = defineProps({
		...
		routeName: {
			type: String,
			default: 'tfviashaburbaedit',
		},
		pagePath: {
			type : String,
			default : 'tfviashaburba/edit',
		},
		apiPath: {
			type: String,
			default: 'tfviashaburba/edit',
