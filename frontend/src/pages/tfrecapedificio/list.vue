                ...
                <div class="container-fluid">
                    <div class="row justify-between items-center q-col-gutter-md">
                        ...
                        <div  class="col-md-auto col-12 " >
                            <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   :to="`/tfrecapedificio/add`" class="full-width" >
                ...
                <div class="row q-col-gutter-x-md">
                    <div  class="col comp-grid" >
                        ...
                        <div >
                            <template v-if="showBreadcrumbs && pageBreadCrumb.fieldName">
                                <q-card class="q-pa-md q-mb-sm text-bold nice-shadow-6">
                                    <q-breadcrumbs>
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="pageBreadCrumb.fieldName" to="/tfrecapedificio"></q-breadcrumbs-el>
                        ...
                        <div >
                            ...
                            :bordered="false"
                            :columns="app.menus.tfrecapedificiolistheader" 
                            :rows="records"
                            ...
                            <template v-slot:body="props">
                                <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                    ...
                                    <q-td  key="id_ficha" :props="props">
                                        <q-btn padding="xs"   :rounded="false"  color="primary"  no-caps  unelevated   flat :to="`/tfrecapedificio/view/${props.row.id_ficha}`">{{ props.row.id_ficha }}</q-btn>
                                    </q-td>
                                    <q-td  key="edificio" :props="props">
                                        {{ props.row.edificio }}
                                    </q-td>
                                    <q-td  key="total_porcentaje" :props="props">
                                        {{ props.row.total_porcentaje }}
                                    </q-td>
                                    <q-td  key="total_atc" :props="props">
                                        {{ props.row.total_atc }}
                                    </q-td>
                                    <q-td  key="total_acc" :props="props">
                                        {{ props.row.total_acc }}
                                    </q-td>
                                    <q-td  key="total_aoic" :props="props">
                                        {{ props.row.total_aoic }}
                                    </q-td>
                                    <q-td  key="id_recap" :props="props">
                                        {{ props.row.id_recap }}
                                    </q-td>
                                            ...
                                            <q-btn icon="menu" padding="xs" round flat color="grey">
                                                <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                    <q-list dense rounded nav>
                                                        <q-item link clickable v-ripple :to="`/tfrecapedificio/view/${props.row.id_ficha}`">
                                                            <q-item-section>
                                                                <q-icon color="primary" size="sm" name="visibility"></q-icon>
                                                            </q-item-section>
                                                            <q-item-section>View</q-item-section>
                                                        </q-item>
                                                        <q-item link clickable v-ripple :to="`/tfrecapedificio/edit/${props.row.id_ficha}`">
                                                            <q-item-section>
...
<script setup>
	...
	const props = defineProps({
		...
		routeName : {
			type : String,
			default : 'tfrecapedificiolist',
		},
		apiPath : {
			type : String,
			default : 'tfrecapedificio/index',
		},
		autoLoad: {
			type: Boolean,
			default: true,
