                                    ...
                                    <div class="row q-col-gutter-x-md">
                                        ...
                                        <div class="col-12">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9 col-12">
                                                    <api-data-source @loaded="response => mapOptionField(response, 'id_puerta')"  api-path="components_data/id_puerta_option_list"  v-slot="req">
                                                        <nice-select     :loading="req.loading"   ref="ctrlid_puerta" v-model="formData.id_puerta" :options="req.response" label="Id Puerta"  :error="isFieldValid('id_puerta')" :error-message="getFieldError('id_puerta')">
                                                        </nice-select>  
                                                    </api-data-source>
                                                </div>
                                            </div>
...
<script setup>
	...
	const props = defineProps({
		...
		routeName: {
			type: String,
			default: 'tfingresosedit',
		},
		pagePath: {
			type : String,
			default : 'tfingresos/edit',
		},
		apiPath: {
			type: String,
			default: 'tfingresos/edit',
